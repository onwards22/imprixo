<?php
$page_title = "Discovery FR 275 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Discovery FR 275 pour impression grand format ✓ Prix dégressifs 22€→14.1€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DISCOVERY-FR-275.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Discovery FR 275",
    "description": "Support textile Discovery FR 275",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">99</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DISCOVERY-FR-275',
    nom: 'Discovery FR 275',
    sousTitre: 'Textile Discovery',
    descCourte: `Support textile Discovery FR 275`,
    descLongue: `Support textile professionnel Discovery FR 275. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
