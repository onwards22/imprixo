<?php
$page_title = "Maya 115 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Maya 115 B1 pour impression grand format ✓ Prix dégressifs 12€→7.7€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/MAYA-115-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Maya 115 B1",
    "description": "Support textile Maya 115 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">58</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'MAYA-115-B1',
    nom: 'Maya 115 B1',
    sousTitre: 'Textile Maya',
    descCourte: `Support textile Maya 115 B1`,
    descLongue: `Support textile professionnel Maya 115 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
