<?php
$page_title = "Polytent Sun 285 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Polytent Sun 285 pour impression grand format ✓ Prix dégressifs 24€→15.4€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/POLYTENT-SUN-285.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Polytent Sun 285",
    "description": "Support textile Polytent Sun 285",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">73</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'POLYTENT-SUN-285',
    nom: 'Polytent Sun 285',
    sousTitre: 'Textile Polytent',
    descCourte: `Support textile Polytent Sun 285`,
    descLongue: `Support textile professionnel Polytent Sun 285. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
