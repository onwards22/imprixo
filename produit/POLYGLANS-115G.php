<?php
$page_title = "Polyglans 115g - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Polyglans 115g pour impression grand format ✓ Prix dégressifs 10€→6.4€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/POLYGLANS-115G.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Polyglans 115g",
    "description": "Support textile Polyglans 115g",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">91</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    ...
    descCourte: `Support textile Polyglans 115g`,
    descLongue: `Support textile professionnel Polyglans 115g. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
