<?php
$page_title = "Textiel Mesh 220 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Textiel Mesh 220 B1 pour impression grand format ✓ Prix dégressifs 21€→13.4€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/TEXTIEL-MESH-220-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Textiel Mesh 220 B1",
    "description": "Support textile Textiel Mesh 220 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">54</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'TEXTIEL-MESH-220-B1',
    nom: 'Textiel Mesh 220 B1',
    sousTitre: 'Textile Textiel',
    descCourte: `Support textile Textiel Mesh 220 B1`,
    descLongue: `Support textile professionnel Textiel Mesh 220 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
