<?php
$page_title = "PVC Backlite 510 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "PVC Backlite 510 pour impression grand format ✓ Prix dégressifs 21€→13.4€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/PVC-BACKLITE-510.php";
?>
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">93</span> en stock !
    </p>
</div>
