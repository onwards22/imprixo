<?php
$page_title = "Forex 3mm (PVC Foam) - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Forex 3mm (PVC Foam) pour impression grand format ✓ Prix dégressifs 32€→20€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FX-3MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Forex 3mm (PVC Foam)",
    "description": "PVC expans\u00e9 3mm - Le plus populaire",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">44</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'FX-3MM',
    nom: 'Forex 3mm (PVC Foam)',
    sousTitre: 'PVC Foam - Standard polyvalent',
    descCourte: `PVC expansé 3mm - Le plus populaire`,
    descLongue: `Panneau PVC expansé 3mm, standard du marché. Structure alvéolaire légère et rigide. Excellent rapport qualité/prix. Résistant aux intempéries. Facile à travailler. Impression HD. Classement M1. Parfait pour enseignes, panneaux, PLV, stands.`,
    categorie: 'Supports rigides PVC',
    poids: 1.75,
    epaisseur: '3mm',
    formatMax: '200x300',
