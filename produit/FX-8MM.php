<?php
$page_title = "Forex 8mm (PVC Foam) - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Forex 8mm (PVC Foam) pour impression grand format ✓ Prix dégressifs 58€→40€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FX-8MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Forex 8mm (PVC Foam)",
    "description": "PVC expans\u00e9 8mm ultra-rigide",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
const PRODUCT_DATA = {
    code: 'FX-8MM',
    nom: 'Forex 8mm (PVC Foam)',
    sousTitre: 'PVC Foam - Haute rigidité',
    descCourte: `PVC expansé 8mm ultra-rigide`,
    descLongue: `Panneau PVC expansé 8mm ultra-rigide. Structure renforcée grands formats. Ne gondole jamais. Parfait enseignes pro, panneaux architecturaux, structures autoportantes. Excellente résistance mécanique et climatique. M1.`,
