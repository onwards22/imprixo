<?php
$page_title = "Discovery FR 275 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Discovery FR 275 B1 pour impression grand format ✓ Prix dégressifs 24€→15.4€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DISCOVERY-FR-275-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Discovery FR 275 B1",
    "description": "Support textile Discovery FR 275 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">57</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DISCOVERY-FR-275-B1',
    nom: 'Discovery FR 275 B1',
    sousTitre: 'Textile Discovery',
    descCourte: `Support textile Discovery FR 275 B1`,
    descLongue: `Support textile professionnel Discovery FR 275 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
