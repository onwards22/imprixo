<?php
$page_title = "Stretch 240g B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Stretch 240g B1 pour impression grand format ✓ Prix dégressifs 22€→14.1€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/STRETCH-240G-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Stretch 240g B1",
    "description": "Support textile Stretch 240g B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">38</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'STRETCH-240G-B1',
    nom: 'Stretch 240g B1',
    sousTitre: 'Textile Stretch',
    descCourte: `Support textile Stretch 240g B1`,
    descLongue: `Support textile professionnel Stretch 240g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
