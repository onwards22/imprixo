<?php
$page_title = "Mesh 270 B1 Light - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Mesh 270 B1 Light pour impression grand format ✓ Prix dégressifs 10€→6.4€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/MESH-270-B1-LIGHT.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Mesh 270 B1 Light",
    "description": "Support textile Mesh 270 B1 Light",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">67</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'MESH-270-B1-LIGHT',
    nom: 'Mesh 270 B1 Light',
    sousTitre: 'Textile Mesh',
    descCourte: `Support textile Mesh 270 B1 Light`,
    descLongue: `Support textile professionnel Mesh 270 B1 Light. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
