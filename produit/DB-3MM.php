<?php
$page_title = "Dibond Alu 3mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Dibond Alu 3mm pour impression grand format ✓ Prix dégressifs 58€→40€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DB-3MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Dibond Alu 3mm",
    "description": "Composite aluminium 3mm - Standard professionnel",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">72</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DB-3MM',
    nom: 'Dibond Alu 3mm',
    sousTitre: 'Aluminium composite - Standard pro',
    descCourte: `Composite aluminium 3mm - Standard professionnel`,
    descLongue: `Panneau composite 2 faces alu + âme polyéthylène. LE standard enseignes professionnelles. Rigidité exceptionnelle, ne gondole jamais. Résistance extrême UV, pluie, vent. Finition mate, brillante ou brossée. Garantie 10+ ans extérieur. Idéal façades, enseignes durables, signalétique urbaine.`,
    categorie: 'Supports aluminium premium',
    poids: 4,
    epaisseur: '3mm',
    formatMax: '150x405',
    usage: 'Extérieur longue durée',
    dureeVie: '10+ ans',
    certification: 'M1 - Ignifugé',
    finition: 'Mat, brillant ou brossé',
    impressionFaces: 'Simple ou double',
    prix: {
        '0-10': 58,
        '11-50': 52,
        '51-100': 48,
