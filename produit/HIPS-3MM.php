<?php
$page_title = "HIPS 3mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "HIPS 3mm pour impression grand format ✓ Prix dégressifs 38€→26€/m² ✓ Livraison 3j ✓ Qualité pro Non classé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/HIPS-3MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "HIPS 3mm",
    "description": "Alternative entre Forex et Dibond",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">87</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'HIPS-3MM',
    nom: 'HIPS 3mm',
    sousTitre: 'Polystyrène choc - Alternatif malin',
    descCourte: `Alternative entre Forex et Dibond`,
    descLongue: `Panneau HIPS (High Impact Polystyrene) 3mm. Rigidité proche Dibond, prix proche Forex. Excellente alternative économique. Résistant aux chocs. Parfait pour enseignes boutiques, PLV semi-permanente, panneaux intérieurs. Bonne tenue extérieur abrité. Finition brillante.`,
    categorie: 'Supports plastiques alternatifs',
    poids: 2.5,
    epaisseur: '3mm',
    formatMax: '205x305',
    usage: 'Intérieur/Extérieur abrité',
    dureeVie: '3-5 ans',
    certification: 'Non classé',
