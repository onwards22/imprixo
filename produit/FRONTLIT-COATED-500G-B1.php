<?php
$page_title = "Frontlit coated 500g B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Frontlit coated 500g B1 pour impression grand format ✓ Prix dégressifs 9€→5.8€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FRONTLIT-COATED-500G-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Frontlit coated 500g B1",
    "description": "Support textile Frontlit coated 500g B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">50</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'FRONTLIT-COATED-500G-B1',
    nom: 'Frontlit coated 500g B1',
    sousTitre: 'Textile Frontlit',
    descCourte: `Support textile Frontlit coated 500g B1`,
    descLongue: `Support textile professionnel Frontlit coated 500g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
