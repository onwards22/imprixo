<?php
$page_title = "Air Polyglans CiCLO 110 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Air Polyglans CiCLO 110 B1 pour impression grand format ✓ Prix dégressifs 20€→12.8€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/AIR-POLYGLANS-CICLO-110-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Air Polyglans CiCLO 110 B1",
    "description": "Support textile Air Polyglans CiCLO 110 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
const PRODUCT_DATA = {
    code: 'AIR-POLYGLANS-CICLO-110-B1',
    nom: 'Air Polyglans CiCLO 110 B1',
    sousTitre: 'Textile Air',
    descCourte: `Support textile Air Polyglans CiCLO 110 B1`,
    descLongue: `Support textile professionnel Air Polyglans CiCLO 110 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
    categorie: 'Textiles écologiques',
    poids: 0.3,
    epaisseur: '-',
    formatMax: 'Illimité',
