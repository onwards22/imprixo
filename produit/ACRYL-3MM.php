<?php
$page_title = "Acrylique Transparent 3mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Acrylique Transparent 3mm pour impression grand format ✓ Prix dégressifs 56€→40€/m² ✓ Livraison 3j ✓ Qualité pro M3 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/ACRYL-3MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Acrylique Transparent 3mm",
    "description": "Plexiglass transparent pour affichage luxe",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">51</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'ACRYL-3MM',
    nom: 'Acrylique Transparent 3mm',
    sousTitre: 'PMMA - Transparent brillant',
    descCourte: `Plexiglass transparent pour affichage luxe`,
    descLongue: `Panneau acrylique (PMMA) transparent brillant. Effet vitrine premium. Idéal présentoirs luxe, PLV haut de gamme, signalétique moderne. Transparence cristalline. Résistant chocs. Facile à nettoyer. Attention : impression UV uniquement.`,
    categorie: 'Supports transparents',
    poids: 3.6,
    epaisseur: '3mm',
    formatMax: '203x300',
    usage: 'Intérieur/Extérieur abrité',
    dureeVie: '10+ ans',
    certification: 'M3',
    finition: 'Transparent brillant',
