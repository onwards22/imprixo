<?php
$page_title = "Decor Blockout 400g Double-Sided - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Decor Blockout 400g Double-Sided pour impression grand format ✓ Prix dégressifs 42€→26.9€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DECOR-BLOCKOUT-400G-DOUBLE-SID.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Decor Blockout 400g Double-Sided",
    "description": "Support textile Decor Blockout 400g Double-Sided",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">41</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DECOR-BLOCKOUT-400G-DOUBLE-SID',
    nom: 'Decor Blockout 400g Double-Sided',
    sousTitre: 'Textile Decor',
    descCourte: `Support textile Decor Blockout 400g Double-Sided`,
    descLongue: `Support textile professionnel Decor Blockout 400g Double-Sided. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
