<?php
$page_title = "Palboard 3mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Palboard 3mm pour impression grand format ✓ Prix dégressifs 52€→36€/m² ✓ Livraison 3j ✓ Qualité pro Non classé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/PALB-3MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Palboard 3mm",
    "description": "PVC alv\u00e9olaire l\u00e9ger et r\u00e9sistant",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">49</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'PALB-3MM',
    nom: 'Palboard 3mm',
    sousTitre: 'PVC alvéolaire - Haut de gamme',
    descCourte: `PVC alvéolaire léger et résistant`,
    descLongue: `Panneau PVC alvéolaire haute qualité. Structure nid d'abeille ultra-résistante. Très léger mais rigide. Parfait PLV premium, présentoirs, totems. Excellente tenue couleurs. Surface lisse parfaite impression. Recyclable.`,
    categorie: 'Supports plastiques premium',
    poids: 1.8,
    epaisseur: '3mm',
    formatMax: '200x300',
