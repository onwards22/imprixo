<?php
$page_title = "Blockout Roll-UP 440 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Blockout Roll-UP 440 pour impression grand format ✓ Prix dégressifs 20€→12.8€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/BLOCKOUT-ROLL-UP-440.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Blockout Roll-UP 440",
    "description": "Support textile Blockout Roll-UP 440",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">37</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'BLOCKOUT-ROLL-UP-440',
    nom: 'Blockout Roll-UP 440',
    sousTitre: 'Textile Blockout',
    descCourte: `Support textile Blockout Roll-UP 440`,
    descLongue: `Support textile professionnel Blockout Roll-UP 440. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
