<?php
$page_title = "Polyglans 115g B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Polyglans 115g B1 pour impression grand format ✓ Prix dégressifs 12€→7.7€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/POLYGLANS-115G-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Polyglans 115g B1",
    "description": "Support textile Polyglans 115g B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">68</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'POLYGLANS-115G-B1',
    nom: 'Polyglans 115g B1',
    sousTitre: 'Textile Polyglans',
    descCourte: `Support textile Polyglans 115g B1`,
    descLongue: `Support textile professionnel Polyglans 115g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
