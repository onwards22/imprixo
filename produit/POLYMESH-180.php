<?php
$page_title = "Polymesh 180 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Polymesh 180 pour impression grand format ✓ Prix dégressifs 22€→14.1€/m² ✓ Livraison 3j ✓ Qualité pro M2 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/POLYMESH-180.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Polymesh 180",
    "description": "Support textile Polymesh 180",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">78</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'POLYMESH-180',
    nom: 'Polymesh 180',
    sousTitre: 'Textile Polymesh',
    descCourte: `Support textile Polymesh 180`,
    descLongue: `Support textile professionnel Polymesh 180. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
