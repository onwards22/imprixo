<?php
$page_title = "Dibond Alu 2mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Dibond Alu 2mm pour impression grand format ✓ Prix dégressifs 58€→40€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DB-2MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Dibond Alu 2mm",
    "description": "Composite aluminium 2mm ultra-l\u00e9ger",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">47</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DB-2MM',
    nom: 'Dibond Alu 2mm',
    sousTitre: 'Aluminium composite - Léger',
    descCourte: `Composite aluminium 2mm ultra-léger`,
    descLongue: `Panneau composite aluminium 2 faces + âme polyéthylène. Ultra-léger mais rigide. Parfait enseignes intérieures haut de gamme, panneaux décoratifs. Finition mate ou brillante. Ne rouille jamais. Aspect professionnel premium.`,
    ...
    finition: 'Mat blanc ou brillant',
