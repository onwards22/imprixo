<?php
$page_title = "Dibond Alu 3mm Brossé - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Dibond Alu 3mm Brossé pour impression grand format ✓ Prix dégressifs 60€→45€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DB-3MM-BRUSH.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Dibond Alu 3mm Bross\u00e9",
    "description": "Composite aluminium bross\u00e9 effet m\u00e9tal",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">56</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'DB-3MM-BRUSH',
    nom: 'Dibond Alu 3mm Brossé',
    sousTitre: 'Aluminium brossé - Prestige',
    descCourte: `Composite aluminium brossé effet métal`,
    descLongue: `Panneau Dibond 3mm finition brossée premium. Aspect aluminium brossé du plus bel effet. Qualité prestige pour enseignes haut de gamme, plaques professionnelles, signalétique luxe. Résistance maximale extérieur. Garantie 10+ ans.`,
