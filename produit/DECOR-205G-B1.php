<?php
$page_title = "Decor 205g B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Decor 205g B1 pour impression grand format ✓ Prix dégressifs 14€→9€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/DECOR-205G-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Decor 205g B1",
    "description": "Support textile Decor 205g B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">88</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    ...
    descCourte: `Support textile Decor 205g B1`,
    descLongue: `Support textile professionnel Decor 205g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
