<?php
$page_title = "Stretch Backlite 210g B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Stretch Backlite 210g B1 pour impression grand format ✓ Prix dégressifs 30€→19.2€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/STRETCH-BACKLITE-210G-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Stretch Backlite 210g B1",
    "description": "Support textile Stretch Backlite 210g B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">100</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'STRETCH-BACKLITE-210G-B1',
    nom: 'Stretch Backlite 210g B1',
    sousTitre: 'Textile Stretch',
    descCourte: `Support textile Stretch Backlite 210g B1`,
    descLongue: `Support textile professionnel Stretch Backlite 210g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
