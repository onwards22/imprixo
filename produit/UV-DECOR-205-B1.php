<?php
$page_title = "UV Decor 205 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "UV Decor 205 B1 pour impression grand format ✓ Prix dégressifs 16€→10.2€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/UV-DECOR-205-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "UV Decor 205 B1",
    "description": "Support textile UV Decor 205 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">85</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'UV-DECOR-205-B1',
    nom: 'UV Decor 205 B1',
    sousTitre: 'Textile UV',
    descCourte: `Support textile UV Decor 205 B1`,
    descLongue: `Support textile professionnel UV Decor 205 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
