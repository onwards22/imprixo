<?php
$page_title = "Forex 2mm (PVC Foam) - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Forex 2mm (PVC Foam) pour impression grand format ✓ Prix dégressifs 32€→20€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FX-2MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Forex 2mm (PVC Foam)",
    "description": "PVC expans\u00e9 2mm pour affichage l\u00e9ger",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">36</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'FX-2MM',
    nom: 'Forex 2mm (PVC Foam)',
    sousTitre: 'PVC Foam - Ultra léger',
    descCourte: `PVC expansé 2mm pour affichage léger`,
    descLongue: `Panneau PVC expansé ultra-léger 2mm. Structure alvéolaire fine. Parfait pour kakémonos légers, affichage intérieur temporaire. Facile à découper et percer. Classement au feu M1.`,
