<?php
$page_title = "Sound Mesh 250 B1 - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Sound Mesh 250 B1 pour impression grand format ✓ Prix dégressifs 15€→9.6€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/SOUND-MESH-250-B1.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Sound Mesh 250 B1",
    "description": "Support textile Sound Mesh 250 B1",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">45</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'SOUND-MESH-250-B1',
    nom: 'Sound Mesh 250 B1',
    sousTitre: 'Textile Sound',
    descCourte: `Support textile Sound Mesh 250 B1`,
    descLongue: `Support textile professionnel Sound Mesh 250 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
