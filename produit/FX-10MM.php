<?php
$page_title = "Forex 10mm (PVC Foam) - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Forex 10mm (PVC Foam) pour impression grand format ✓ Prix dégressifs 68€→50€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FX-10MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Forex 10mm (PVC Foam)",
    "description": "PVC expans\u00e9 10mm pour structures",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
const PRODUCT_DATA = {
    code: 'FX-10MM',
    nom: 'Forex 10mm (PVC Foam)',
    sousTitre: 'PVC Foam - Structure',
    descCourte: `PVC expansé 10mm pour structures`,
    descLongue: `Panneau PVC expansé 10mm ultra-épais. Rigidité maximale. Usage structurel : présentoirs, totems, mobilier événementiel. Excellente isolation. Tenue mécanique exceptionnelle. M1.`,
    categorie: 'Supports rigides PVC',
    poids: 5.9,
    epaisseur: '10mm',
    formatMax: '200x300',
    usage: 'Extérieur/Structure',
    dureeVie: '7-10 ans',
