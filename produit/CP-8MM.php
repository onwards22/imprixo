<?php
$page_title = "Channel Plate 8mm - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Channel Plate 8mm pour impression grand format ✓ Prix dégressifs 22€→13€/m² ✓ Livraison 3j ✓ Qualité pro Non classé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/CP-8MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Channel Plate 8mm",
    "description": "Support carton l\u00e9ger pour PLV temporaire",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">48</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'CP-8MM',
    nom: 'Channel Plate 8mm',
    sousTitre: 'Support carton - Économique',
    descCourte: `Support carton léger pour PLV temporaire`,
    descLongue: `Support en carton alvéolaire blanc. Idéal affichage temporaire magasin, événements courts, tests produits. Léger et facile à découper. Surface lisse pour impression qualité. Recyclable.`,
    categorie: 'Supports rigides économiques',
    poids: 0.5,
    epaisseur: '8mm',
    formatMax: '200x300',
