<?php
$page_title = "Forex 5mm (PVC Foam) - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Forex 5mm (PVC Foam) pour impression grand format ✓ Prix dégressifs 45€→30€/m² ✓ Livraison 3j ✓ Qualité pro M1 - Ignifugé ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/FX-5MM.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Forex 5mm (PVC Foam)",
    "description": "PVC expans\u00e9 5mm pour enseignes durables",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">92</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'FX-5MM',
    nom: 'Forex 5mm (PVC Foam)',
    sousTitre: 'PVC Foam - Rigidité supérieure',
    descCourte: `PVC expansé 5mm pour enseignes durables`,
    descLongue: `Panneau PVC expansé 5mm renforcé. Excellente rigidité, ne fléchit pas. Idéal enseignes extérieures, panneaux chantier, affichage permanent. Résiste UV et intempéries. Classement M1.`,
