<?php
$page_title = "Mesh 330 B1 Double-Sided - Impression Grand Format | Prix Dégressifs | Imprixo";
$page_description = "Mesh 330 B1 Double-Sided pour impression grand format ✓ Prix dégressifs 25€→16€/m² ✓ Livraison 3j ✓ Qualité pro B1 ✓ Devis gratuit";
$canonical_url = "https://imprixo.fr/produit/MESH-330-B1-DOUBLE-SIDED.php";
?>
...
<script type="application/ld+json">
{
    ...
    "@type": "Product",
    "name": "Mesh 330 B1 Double-Sided",
    "description": "Support textile Mesh 330 B1 Double-Sided",
    "brand": {
        "@type": "Brand",
        "name": "Imprixo"
    },
...
<div class="bg-gradient-to-r from-red-600 to-red-500 text-white py-3 text-center">
    <p class="font-bold text-sm md:text-base">
        🔥 OFFRE LIMITÉE : Livraison GRATUITE dès 200€ + Devis sous 1h | Plus que <span class="pulse">59</span> en stock !
    </p>
</div>
...
const PRODUCT_DATA = {
    code: 'MESH-330-B1-DOUBLE-SIDED',
    nom: 'Mesh 330 B1 Double-Sided',
    sousTitre: 'Textile Mesh',
    descCourte: `Support textile Mesh 330 B1 Double-Sided`,
    descLongue: `Support textile professionnel Mesh 330 B1 Double-Sided. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.`,
